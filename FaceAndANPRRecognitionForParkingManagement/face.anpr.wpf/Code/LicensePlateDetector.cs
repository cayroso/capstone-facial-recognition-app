...
namespace face.anpr.wpf.Code
{
    public class LicensePlateDetector : DisposableObject
    {
        ...
        public LicensePlateDetector(String dataPath)
        {
            ...
            //#endif
            InitOcr(dataPath, "osd", OcrEngineMode.TesseractLstmCombined);
        ...
        public static void TesseractDownloadLangFile(String folder, String lang)
        {
            ...
            if (!System.IO.File.Exists(dest))
                ...
                {
                    String source = GetLangFileUrl(lang);
        ...
        private void InitOcr(String path, String lang, OcrEngineMode mode)
        {
            try
            {
                ...
                if (String.IsNullOrEmpty(path))
                    path = DefaultTesseractDirectory;
        ...
        public List<String> DetectLicensePlate(
           ...
           List<RotatedRect> detectedLicensePlateRegionList, double rWidth, double rHeight)
        {
        ...
        private void FindLicensePlate(
           ...
           List<String> licenses, double rWidth, double rHeight)
        {
                    ...
                    if (CvInvoke.ContourArea(contour) > 400)
                    {
                        if (numberOfChildren < 3)
                        {
                            ...
                            FindLicensePlate(contours, hierachy, hierachy[idx, 2], gray, canny, licensePlateImagesList,
                               filteredLicensePlateImagesList, detectedLicensePlateRegionList, licenses, rWidth, rHeight);
                            continue;
                        }
                        ...
                        //if (!(6.0 < whRatio && whRatio < 12.0))
                        if (!(rHeight < whRatio && whRatio < rWidth))
                        {
